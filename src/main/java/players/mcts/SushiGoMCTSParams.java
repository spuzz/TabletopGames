...
public class SushiGoMCTSParams extends PlayerParameters {
    ...
    public SushiGoMCTSParams() {
        this(System.currentTimeMillis());
    }

    public SushiGoMCTSParams(long seed) {
        super(seed);
    ...
    @Override
    protected SushiGoMCTSParams _copy() {
        SushiGoMCTSParams retValue = new SushiGoMCTSParams(System.currentTimeMillis());
        retValue.K = K;
    ...
    @Override
    public SushiGoMCTSPlayer instantiate() {
        return new SushiGoMCTSPlayer(this);
    }
